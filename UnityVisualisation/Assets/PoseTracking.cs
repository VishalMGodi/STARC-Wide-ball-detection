...
public class NewBehaviourScript : MonoBehaviour {
    ...
    void Start() {
        PosePosition = new Vector3(-4.1f, -1.75f, 0.82f);
        PoseScale = new Vector3(1f, 1f, 1f);
        PoseRotation = new Vector3(0,180,0);
        PoseDiv = new Vector3(122,114.7f,234);
        groundOffset = 0.0f;
        PosePointsGroup.transform.localPosition = new Vector3(0.966f,-0.62f, -1.964f);
    }

    // Update is called once per frame 3.5, -1.02 -2.834
    void Update() {
        ...
        PosePointsGroup.transform.localPosition = new Vector3(-2.228f,-0.576f, 0.961f);
